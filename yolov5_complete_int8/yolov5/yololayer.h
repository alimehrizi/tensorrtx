...
namespace Yolo
{
    ...
    static constexpr float NMS_THRESH = 0.6;
   ...
   static constexpr int DET_SIZE = sizeof(Detection) / sizeof(float);
   static constexpr int OUTPUT_SIZE = MAX_OUTPUT_BBOX_COUNT * sizeof(Detection) / sizeof(float) + 1;
