...
ICudaEngine* build_engine(unsigned int maxBatchSize, IBuilder* builder, IBuilderConfig* config, DataType dt, float& gd, float& gw, std::string& wts_name) {
    ...
    Int8EntropyCalibrator2* calibrator = new Int8EntropyCalibrator2(1, INPUT_W, INPUT_H, "/home/altex/Mehrizi/Datasets/Traffic Object Detection-v1.0/cctv_car_all/test/images/", "TOD_v1.0_calib.table", INPUT_BLOB_NAME);
